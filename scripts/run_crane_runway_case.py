...
from section_core.crane_runway import CraneRunwayCaseErrorFormatter, run_crane_runway_case_json
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Execute a crane runway JSON case file and print text/markdown/JSON reports."
    )
...
def _render_output(args: argparse.Namespace, result_text: str, result_markdown: str, summary_dict: dict[str, object]) -> str:
    if args.markdown:
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        output = _render_output(args, result.text_report, result.markdown_report, result.summary_dict)
