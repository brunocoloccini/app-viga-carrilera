...
<script src="/assets/local_ui.js"></script><div style="display:none">renderVisualWorkflowMap updateVisualWorkflowMap getVisualWorkflowStatus setVisualWorkflowStatus handleWorkflowCardAction setUiMode getUiMode applyUiMode toggleSimpleMode toggleExpertMode handleTopAction computeNextUserAction renderNextUserAction updateNextUserAction</div></body></html>"""
