...
def build_section() -> Section:
    ...
    section = Section(section_id="V1-015-example", components=[base_shape])
...
if __name__ == "__main__":
    ...
    print("Note: base shape uses tabulated gross properties; cover plate properties come from geometry.")
