...
def build_cover_plated_i_section() -> Section:
    ...
    cover_plate = PlateElement.horizontal_plate(
        element_id="cover_plate", width=260, width_unit="mm", thickness=10, thickness_unit="mm", center_y=0, center_y_unit="mm", center_z=0, center_z_unit="mm"
    )

    section = Section(section_id="V1-013-example", components=[bottom_flange])
...
if __name__ == "__main__":
    ...
    print("Note: S_y_top and S_y_bottom differ due to top cover plate monosymmetry.")
